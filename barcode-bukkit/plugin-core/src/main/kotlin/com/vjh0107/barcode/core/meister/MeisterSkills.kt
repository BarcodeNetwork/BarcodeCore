...
enum class MeisterSkills(
    ...
    val maxLevel: Int,
    val parameter: MeisterParameter,
    vararg val lore: String,
    val loreType: LoreTypes = LoreTypes.PERCENT
) {
    MANA_FOUNTAIN(0,
        "마나샘", 0, 50, MeisterParameter.of(5.0, 0.9),
        "&7채집/채광 완료 시 &e{parameter}% &7확률로",
        "&b레테르 파편&7을 획득한다."
    ),
    CRUSHER(1,
        "분쇄기", 20, 50, MeisterParameter.of(1.0, 0.08),
        "&7채집/채광 중 &e{parameter}% &7확률로 &e5초&7간",
        "&b공격속도&7가 &e2배 &7증가한다."
    ),
    DEMATERIALIZE(2,
        "해체 분석", 40, 50, MeisterParameter.of(3.0, 0.14),
        "&7채집/채광 중 &e{parameter}% &7확률로",
        "&e2배&7의 피해를 입힌다."
    ),
    LUCK(3,
        "행운", 60, 50, MeisterParameter.of(1.0, 0.12),
        "&7채집/채광 완료시 &e{parameter}% &7확률로",
        "&b아이템&7을 추가로 한번 더 지급한다."
    ),
    DESTROYER(4,
        "파괴자", 100, 50, MeisterParameter.of(0.5, 0.03),
        "&7채집/채광 시 &e{parameter}% &7확률로",
        "&b즉시 &7채집/채광을 완료한다."
    ),
    HAND_OF_BLESSING(5,
        "축복의 손길", 150, 50, MeisterParameter.of(10.0, 0.2),
        "&7강화 시도시 파괴 확률이",
        "&7영구적으로 &e{parameter}% &9감소&7한다."
    ),
    ASPIRE_OF_MEISTER(6,
        "장인의 열망", 250, 50, MeisterParameter.of(10.0, 0.2),
        "&7강화 시도시 최대 용량이",
        "&7영구적으로 &e{parameter}% &c증가&7한다.",
        loreType = LoreTypes.LINEAR
    ),
    MASTER(7,
        "명장", 400, 400, MeisterParameter.of(0.0, 0.05),
