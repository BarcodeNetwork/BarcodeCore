package com.vjh0107.barcode.core.meister.gui
...
class PlayerMeisterInventory(override val player: Player) : AbstractBarcodeInventory() {
    val data: CorePlayerPlayerData get() = player.getCorePlayerData()
